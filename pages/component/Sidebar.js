...
const Sidebar = () => {
    ...
    const sidebarAdmin = () => {
        return (
            <Sider trigger={null} collapsible collapsed={false} className="sidebarLayout" width={250} >
                <div className="logo"><span className='sidebarFont'>Administrator</span></div>
                <div className="borT" />
    ...
    const sidebarHr = () => {
        return (
            <Sider trigger={null} collapsible collapsed={false} className="sidebarLayout" width={250} >
                <div className="logo" ><span className='sidebarFont'>HRadministrator</span></div>
                <div className="borT" />
                <Menu className='menuSidebar' mode="inline" defaultSelectedKeys={[router.pathname]}>
                    <Menu.Item className='subMenuSidebar' key="/home" icon={<span className="iconify svgIcon" data-icon="fa-solid:home" data-inline="false"></span>} onClick={() => {
                        router.push('/home')
    ...
    const sidebarSupervisor = () => {
        return (
            <Sider trigger={null} collapsible collapsed={false} className="sidebarLayout" width={250} >
                <div className="logo" ><span className='sidebarFont'>Supervisor</span></div>
                <div className="borT" />
                <Menu className='menuSidebar' mode="inline" defaultSelectedKeys={[router.pathname]}>
                    <Menu.Item className='subMenuSidebar' key="/home" icon={<span className="iconify svgIcon" data-icon="fa-solid:home" data-inline="false"></span>} onClick={() => {
                        router.push('/home')
    ...
    const sidebarStaff = () => {
        return (
            <Sider trigger={null} collapsible collapsed={false} className="sidebarLayout" width={250} >
                <div className="logo"><span className='sidebarFont'>Staff</span></div>
                <div className="borT" />
                <Menu className='menuSidebar' mode="inline" defaultSelectedKeys={[router.pathname]}>
                    <Menu.Item className='subMenuSidebar' key="/home" icon={<span className="iconify svgIcon" data-icon="fa-solid:home" data-inline="false"></span>} onClick={() => {
                        router.push('/home')
