...
export default function index() {
    ...
    useEffect(async () => {
        const resData = Cookies.get('role') != 'Administrator' ? await callService('POST', `${serViceUrl()}allusers/getUserleaveId`, { token: Cookies.get('cookie') }) : await callService('GET', `${serViceUrl()}admin/getUserLeave`)
