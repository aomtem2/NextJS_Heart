...
export default function index() {
    ...
    useEffect(async () => {
        const res = await callService('POST', `${serViceUrl()}allusers/getProfileOne`, { token: Cookies.get('cookie') })
            ...
            <Skeleton loading={loading} active>
                <Formik
                    ...
                    onSubmit={async (values) => {
                        console.log(values);
                        const resData = await callService('POST', `${serViceUrl()}allusers/editAllUser`,
                            {
